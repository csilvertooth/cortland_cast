...
class CortlandCastRestartButton(ButtonEntity):
    ...
    def extra_state_attributes(self):
        """Identify this entity for the Cortland Cast panel."""
        return {
            "cortland_cast_role": "restart_button",
...
class CortlandCastPowerOffButton(ButtonEntity):
    ...
    def extra_state_attributes(self):
        """Identify this entity for the Cortland Cast panel."""
        return {
            "cortland_cast_role": "power_button",
            "cortland_cast_entry_id": self._entry.entry_id,
        }
...
class CortlandCastClearCacheButton(ButtonEntity):
    ...
    @property
    def extra_state_attributes(self):
        """Identify this entity for future Cortland Cast UI features."""
        return {
            "cortland_cast_role": "clear_cache_button",
            "cortland_cast_entry_id": self._entry.entry_id,
        }
